...
HOLDOUT_CSV = Path('data/splits/semantic_holdout.csv')
MODEL_PATH = 'models/bge-m3-finetuned-v18'
CALIB_PATH = Path('data/semantic_calibration_v18_v3.json')
...
def main():
    ...
    summarize('v18_raw', raw, truth)
    summarize('v18_calibrated_v3', calibrated, truth)
