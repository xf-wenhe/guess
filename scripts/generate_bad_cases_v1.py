...
CANDIDATES = [
    ...
    # ── antonym_mid: 反义词按 50% 语义相关度处理 ──────────────────────────────
    ("快乐", "悲伤",     50, "antonym_mid",                "medium",
     "明确反义词，语义相关但方向相反，按 50% 处理",
     "antonym"),
    ("高兴", "难过",     50, "antonym_mid",                "medium",
     "明确情绪反义词，按 50% 语义相关度处理",
     "antonym"),
    ("白天", "黑夜",     50, "antonym_mid",                "medium",
     "时间反义词，同类但方向相反，按 50% 处理",
     "antonym"),
    ("胜利", "失败",     50, "antonym_mid",                "medium",
     "结果反义词，语义相关但方向相反，按 50% 处理",
     "antonym"),
    ("古代", "现代",     50, "antonym_mid",                "medium",
     "时间段反义词，按 50% 处理",
     "antonym"),
    ("永恒", "瞬间",     50, "antonym_mid",                "medium",
     "持续性反义词，按 50% 处理",
     "antonym"),
    ("虚无", "存在",     50, "antonym_mid",                "medium",
     "哲学反义词，按 50% 处理",
     "antonym"),
    ("智慧", "愚昧",     50, "antonym_mid",                "medium",
     "智力反义词，按 50% 处理",
     "antonym"),
